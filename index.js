...
//  - Loop through the array of image elements and assign a string (in order) from your 'randomSources' array to the src attribute of the current image
// . For example, if your randomized array looks like the following:
